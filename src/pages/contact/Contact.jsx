...
const Contact = () => {
  ...
  const onSubmit = (data) => {
    emailjs
      .send(
        "service_lpyzjtm", // Service ID
        "template_tigvdta", // Template ID
        {
  ...
  return (
    <div>
      ...
      <p className="text-center text-gray-500 mb-10 font-primary">
      ...
      <div className="max-w-md md:max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <label
                className="block text-gray-700 font-primary mb-2"
                htmlFor="firstName"
              >
                First Name
              </label>
