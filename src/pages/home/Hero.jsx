  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
        ...
        <p className="text-lg mx-auto text-sm font-primary text-gray-100">
          ...
          <p className=" max-w-[900px] text-lg mx-auto md:text-md mb-4 font-primary text-gray-300">
            ...
            over 2 years of experience in HTML, CSS, Bootstrap, Tailwind CSS and JavaScript. I have also knowledge about React.js and Next.js. I work
